...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pypika-tortoise-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12947&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pypika-tortoise-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pypika-tortoise` can be installed with:

```
conda install pypika-tortoise
```

It is possible to list all of the versions of `pypika-tortoise` available on your platform with:
